...
function uwuWord(word, index) {
  ...
  var isRussian = /[а-яА-ЯЁё]/.test(word);
  ...
  if (isRussian) {
    const replacements = {
      ...
      "нет": "ню",
      "спасибо": "спасибочки",
      "пожалуйста": "пожалуйсточка",
      "извини": "извинишки",
      "люблю": "wюбwю",
      "друг": "дwуг",
      "как дела": "как делёчки",
      "хорошо": "хорошенько",
      "плохо": "плохенько",
      "сделать": "сделатьчи",
      "важно": "важненько",
      "много": "множественно",
      "красивый": "красивульный",
      "хороший": "хорошульный",
      "нравится": "нравишки",
      "счастливый": "счастливчик",
      "грустный": "грустненький",
      "замечательно": "замечательнюльно",
      "спать": "спатьчи",
      "еда": "едаха",
      "пить": "питьёчки",
      "играть": "игратьчи",
    ...
    Object.keys(replacements).forEach((key) => {
      if (word.toLowerCase() === key) word = replacements[key];
    });

    // Phonetic transformations specific to Russian characters for "UwU" effect
    // word = word.replace(/ль/g, 'лw').replace(/р/g, 'w').replace(/л/g, 'в').replace(/Р/g, 'W').replace(/Л/g, 'В');
    word = convertString(word)
  }
 else {
  // English-specific transformations
  word = word.replace(/l/g, 'w').replace(/r/g, 'w').replace(/L/g, 'W').replace(/R/g, 'W');

  // English specific word replacements
  word = word.replace(/you're/g, "uwu").replace(/youre/g, "uwu").replace(/fuck/g, "fwick").replace(/shit/g, "poopoo").replace(/bitch/g, "meanie").replace(/asshole/g, "b-butthole").replace(/dick/g, "peepee").replace(/penis/g, "peepee").replace(/\bcum\b/g, "cummies").replace(/\bsemen\b/g, "seedies").replace(/\bass\b/g, "bummie").replace(/\bdad\b/g, "daddy").replace(/\bfather\b/g, "daddy");
}
